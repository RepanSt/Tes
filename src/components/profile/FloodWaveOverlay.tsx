      ...
      {isFlooding && (
        <div className="fixed inset-0 z-[95] pointer-events-none overflow-hidden select-none">
          <motion.div
            ...
            animate={{ x: '135%' }}
            exit={{ opacity: 0 }}
            transition={{ duration: isMobile ? 2.0 : 3.0, ease: [0.25, 0.9, 0.35, 1] }}
            className="absolute inset-y-0 w-[175%] sm:w-[135%] pointer-events-none flex items-center overflow-visible"
          >
            {/* ocean wave */}
              ...
              >
                <defs>
                  <linearGradient id="deepWaveGrad" x1="0%" y1="0%" x2="100%" y2="0%">
                    <stop offset="0%" stopColor="#013a52" stopOpacity="0.82" />
                    <stop offset="60%" stopColor="#02587a" stopOpacity="0.85" />
                    <stop offset="85%" stopColor="#0284c7" stopOpacity="0.88" />
                  ...
                  <linearGradient id="crestCyanGrad" x1="0%" y1="0%" x2="100%" y2="0%">
                    ...
                    <stop offset="100%" stopColor="#bae6fd" stopOpacity="0.98" />
                  </linearGradient>
